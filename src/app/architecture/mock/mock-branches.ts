...
export const BRANCHES : Finding[] = [
  ...
  {name: "origin/dependabot/maven/stream-sdk/stream-parent/stream-test-support/junit-junit-4.13.1", findings: ["This branch doesn't follow a proper naming convention"]},
  {name: "origin/dependabot/maven/stream-sdk/stream-starter-parents/stream-sdk-starter-core/org.hibernate.validator-hibernate-validator-6.0.20.Final", findings: ["This branch doesn't follow a proper naming convention"]},
